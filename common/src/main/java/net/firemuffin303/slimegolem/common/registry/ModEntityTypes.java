...
public class ModEntityTypes {
    ...
    public static final Supplier<EntityType<SlimeChargeProjectile>> SLIME_CHARGE = ModPlatform.registerEntityType("slime_charge",() -> EntityType.Builder.of(SlimeChargeProjectile::new,MobCategory.MISC).sized(0.4F, 0.4F).eyeHeight(0.0f).clientTrackingRange(4).updateInterval(10));
