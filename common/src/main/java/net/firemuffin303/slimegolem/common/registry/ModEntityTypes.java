...
public class ModEntityTypes {
    ...
    public static final Supplier<EntityType<SlimeGolemEntity>> SLIME_GOLEM = ENTITY_TYPE.register("slime_golem",() -> EntityType.Builder.of(SlimeGolemEntity::new, MobCategory.MISC).sized(0.7f,1.2f).clientTrackingRange(8).build(MuffinsSlimeGolemMod.MOD_ID));
